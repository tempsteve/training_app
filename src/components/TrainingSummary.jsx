...
import { addTrainingRecord, loadUserSettings } from '../utils/storage'
...
function TrainingSummary() {
  ...
  const calories = userSettings ? calculateCalories(trainingData.records, userSettings, trainingData.totalTime) : null
          ...
          <div className="stats-grid">
            ...
            {calories !== null && (
              <div className="stat-item">
                ...
                <div className="stat-label">卡路里 (kcal)</div>
              </div>
            )}
          </div>
        </div>
